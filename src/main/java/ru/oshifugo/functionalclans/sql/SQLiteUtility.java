...
public class SQLiteUtility {
    ...
    public static Map<String, String[]> clans = new HashMap<>();
    public static Map<String, String[]> members = new HashMap<>();
    public static Map<String, String> member_clan = new HashMap<>();
    public static Map<String, String[]> clan_role = new HashMap<>();
    public static Map<String, String[]> clan_alliance = new HashMap<>();
    public static Map<String, ClanChest> clanChests = new HashMap<>();
    ...
    public static void createAsync(@NotNull String clanName, String leader) {
        CompletableFuture.runAsync(() -> create(clanName, leader));
    }
    ...
    public static void create(String clanName, String leader) {
        ...
        String[] clan = {clanName, leader, Utility.config("cash"), Utility.config("rating"), Utility.config("type"), Utility.config("tax"), "&7╰(*´︶`*)╯&c♡", "null", String.valueOf(Utility.configBoolean("verification")), Utility.config("max_player"), "null", "null", String.valueOf(0.0), String.valueOf(0.0), String.valueOf(0.0), String.valueOf(0.0F), String.valueOf(0.0F), d, uid, leader, config.getString("default-pvp", config.getString("chest_pages"))};
        String[] member = {leader, "5", clanName, "0", "0", "0", "0"};
        ...
        clanChests.put(clanName, new ClanChest(Integer.parseInt(uid), config.getInt("chest_pages"), new ArrayList<>()));
    ...
    public static void deleteAsync(@NotNull String clan) {
        CompletableFuture.runAsync(() -> delete(clan));
    }
